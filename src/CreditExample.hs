...
-- https://github.com/ucsd-progsys/liquidhaskell/issues/1288
{-@ measure f @-}
f :: () -> Int
f _ = 0
...
data EntityField Creditcard typ where 
   CreditExample.CreditCardNumber :: EntityField CreditCard {v:_ | True}
 | CreditExample.CreditCardHolder :: EntityField CreditCard {v:_ | True}
@-}
